...
public class FileService {
	...
	public static String saveFile(MultipartFile mfile, String uploadPath) {
		...
		String savedFilename = sdf.format(new Date());	// "20210906"
		
		//원본 파일의 확장자
		String ext;
		// "abc.jpg" -> 3 , "test.abc.jpg" -> 8
